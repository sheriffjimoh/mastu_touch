  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#1a0b2e" }}>
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link
                ...
                href="#services"
                className="text-purple-900  hover:text-purple-900  transition"
              >
                Services
              </Link>
              <Link
                onClick={() => setMobileMenuOpen(false)}
                href="#portfolio"
                className="text-purple-800 hover:text-purple-800 transition"
              >
                Portfolio
              </Link>
              <Link
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pb-4 space-y-3 border-t border-purple-800/30 pt-4">
              <Link
                onClick={() => setMobileMenuOpen(false)}
                href="#services"
                className="block text-purple-900  py-2"
              >
                Services
              </Link>
              <Link
              ...
              <Link
                onClick={() => setMobileMenuOpen(false)}
                href={whatsappLink}
                className="block bg-purple-800 text-orange-100 px-6 py-3 rounded-full font-bold text-center"
              >
                Book Now
              </Link>
            </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #fde8f5 0%, #f5e6ff 50%, #fff5e6 100%)",
        }}
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[90vh]">
            ...
            <div className="relative lg:mt-0 mt-10 order-1 lg:order-1">
              <div className="inline-flex lg:hidden  mb-5  items-center gap-2 bg-orange-100/80 backdrop-blur-sm border border-purple-900  px-4 py-2 rounded-full shadow-sm">
                ...
                <span className="text-sm text-purple-800 font-semibold tracking-wide">
                  TOP BRANDS
                </span>
              </div>
            ...
            <div className="space-y-8 order-2 lg:order-2 lg:py-12 py-10">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
                  Professional makeup artistry that enhances your natural
                  beauty. From bridal glam to everyday elegance, let me create
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm font-medium">
                  Ilorin, Nigeria • Available Nationwide
                </span>
              </div>
            </div>
          </div>
            ...
            {[
              {
                icon: Heart,
                title: "Bridal Makeup",
                desc: "Flawless looks for your special day",
                color: "pink",
              },
              {
                icon: Camera,
                title: "Photoshoot Glam",
                desc: "Camera-ready professional makeup",
                color: "pink",
              },
              {
                icon: Sparkles,
                title: "Special Events",
                desc: "Stand out at any celebration",
                color: "pink",
              },
              {
                icon: Star,
                title: "Makeup Classes",
                desc: "Learn pro techniques from me",
                color: "pink",
              },
            ].map((service, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-orange-50 p-8 rounded-2xl border hover:border-purple-900  transition shadow-xl"
                >
                  <div
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="relative aspect-square rounded-2xl overflow-hidden border-4   transition shadow-xl group cursor-pointer"
              >
                <img
                  src={img}
                  alt={`Makeup work ${i + 1}`}
                  ...
                  onError={(e) => {
                    e.currentTarget.src = `https://via.placeholder.com/600/9333EA/FFFFFF?text=Work+${
                      i + 1
                    }`;
                  }}
                />
                <div className="absolute inset-0 bg-purple-900/0 group-hover:bg-purple-900/60 transition flex items-center justify-center">
                  <Heart
                    className="text-orange-100 opacity-0 group-hover:opacity-100 transition"
                    size={48}
                  />
                </div>
              </div>
          ...
          <div className="text-center mt-12">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center p-4  text-left gap-3 text-purple-900  hover:text-purple-600 font-bold text-xl transition"
            >
              <Instagram size={28} />
      ...
      <section id="contact" className="py-20 bg-orange-100">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <h2 className="lg:text-5xl text-3xl font-bold text-purple-900 mb-6">
            Ready to Glow?
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12 w-full">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-purple-900  lg:w-auto w-full hover:bg-fuchsia-100 text-orange-100 hover:text-purple-900 px-10 py-5 rounded-full font-bold text-xl flex items-center gap-3 shadow-xl transition"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-fuchsia-100 hover:bg-purple-900  text-purple-900  hover:text-orange-100 lg:w-auto w-full text-center  justify-center px-10 py-5 rounded-full font-bold text-xl flex items-center gap-3 transition"
            >
              <Instagram size={28} />
              Follow Me
            </Link>
      ...
      {/* Footer */}
      <footer
        className="py-12 border-t border-purple-900 "
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-purple-300 mb-6">
            Professional Makeup Artistry • Ilorin, Nigeria
          </p>
          <div className="flex justify-center gap-4 mb-8">
            <a
              href={whatsappLink}
              className="w-12 h-12 bg-purple-900  hover:bg-purple-900  rounded-full flex items-center justify-center transition"
            >
          ...
          <p className="text-purple-400 text-sm">
            &copy; 2025 Mastu Touch. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
